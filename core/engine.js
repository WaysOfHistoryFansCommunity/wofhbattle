...
var Module = {
    ...
    locateFile: function (file) {
        ...
        if (file === "GeWebLauncher.wasm")
            return window.ge.scriptPrefix + "js/platform/GeWebLauncher.wasm?" + window.ge.version;
        return file;
    },
    arguments: [],
};
...
var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 503316480;
var wasmTable;
var __ATPRERUN__ = [];
var __ATINIT__ = [];
var __ATMAIN__ = [];
